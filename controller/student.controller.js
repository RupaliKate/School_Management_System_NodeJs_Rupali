...
//Imports from the schema files to handle student and class data.
const Student = require('../schemas/student.schema');
const Class = require('../schemas/class.schema');

// adds new student after validating the request body.
...
//get all students using an aggregated method
